...
abstract class $CryptoPriceCopyWith<$Res> {
  ...
  @useResult
  $Res call({double polygon, double ethereum, double bsc});
}
...
class _$CryptoPriceImpl implements _CryptoPrice {
  _$CryptoPriceImpl({this.polygon = 0.0, this.ethereum = 0.0, this.bsc = 0.0});
...
// 1027
  ...
  @override
  String toString() {
    return 'CryptoPrice(polygon: $polygon, ethereum: $ethereum, bsc: $bsc)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, polygon, ethereum, bsc);
