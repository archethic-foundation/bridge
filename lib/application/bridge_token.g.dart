...
String _$getTokensListPerBridgeConfHash() =>
    r'24da5aef9bea754bc43bf7ea86ffaefe29f4e429';

/// See also [_getTokensListPerBridgeConf].
@ProviderFor(_getTokensListPerBridgeConf)
final _getTokensListPerBridgeConfProvider =
    AutoDisposeFutureProvider<BridgeTokensPerBridge>.internal(
  _getTokensListPerBridgeConf,
  name: r'_getTokensListPerBridgeConfProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getTokensListPerBridgeConfHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _GetTokensListPerBridgeConfRef
    = AutoDisposeFutureProviderRef<BridgeTokensPerBridge>;
