...
class RefundBlockchainList extends ConsumerWidget {
  const RefundBlockchainList({
    super.key,
  });
    ...
    return SizedBox(
      child: blockchains.when(
        data: (data) {
          ...
          final otherBlockchain = ref.watch(
            refundFormNotifierProvider.select((bridge) => bridge.blockchain),
          );
