...
- secret_hash: the hash of the secret generated by user
```bash
node deploy_chargeable_hltc.js htlc1 1692394020 4 ec9c3a34e791bda21bbcb69ea0eb875857497e0d48c75771b3d1adb5073ce791
```
...
```bash
node reveal_secret.js 0000ec9c3a34e791bda21bbcb69ea0eb875857497e0d48c75771b3d1adb5073ce791 salut
```
