...
The following is a set of guidelines for contributing to AE Bridge which is hosted in the [Archethic Foundation](https://github.com/archethic-foundation) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
* [Github Discussions](https://github.com/archethic-foundation/bridge/discussions)
...
This section guides you through submitting a bug report for AE Bridge. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer: :computer:, and find related reports :mag_right:.
...
* **Check the [discussions](https://github.com/archethic-foundation/bridge/discussions)** for a list of common questions and problems.
* **Check the [issue list](https://github.com/archethic-foundation/bridge/issues)** if it has been already opened.
...
- Maintain AE Bridge app's quality
